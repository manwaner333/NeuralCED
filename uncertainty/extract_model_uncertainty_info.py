...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        try:
            ...
            shifted_input_ids = input_ids[:, question_start_idx + 1:question_end_idx + 1]
            shifted_logits = logits[:, question_start_idx:question_end_idx, :]
            ...
            combined_token_logprobs["ques"] = token_logprobs
            combined_token_entropies["ques"] = token_entropies
